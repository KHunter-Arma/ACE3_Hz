...
if !((_target getVariable [QGVAR(canDrag), false]) && {isNull objectParent _target}) exitWith {false};
...
// Units need to be unconscious, limping or receiving IV; Units also need to not be in ragdoll, as that causes desync issues
