...
private _HzFuelCap = _maxFuelTank;
...
[{
    ...
    _args params [["_source", objNull, [objNull]], ["_sink", objNull, [objNull]], ["_unit", objNull, [objNull]], ["_nozzle", objNull, [objNull]], ["_rate", 1, [0]], ["_maxFuelTank", 1, [0]], ["_connectFromPoint", [0,0,0], [[]], 3], ["_connectToPoint", [0,0,0], [[]], 3], ["_HzFuelCap",0,[1]],["_HzInitFuel",0,[1]],["_HzEconRunning",false,[false]]];
